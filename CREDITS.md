...
Atmosphera incorporates work from many open-source projects and contributors.
This file credits the upstream [Noctalia Shell](https://github.com/noctalia-dev/noctalia-shell) project and its dependencies.

## Noctalia Design & Branding
...
- **[Quickshell](https://github.com/outfoxxed/quickshell)** — The Qt/QML-based Wayland shell framework that powers this project
...
- **[DrNI on Freesound](https://freesound.org/people/DrNI/sounds/34562/)** — Timer alarm sound effect
...
- All the contributors and users of Noctalia Shell
